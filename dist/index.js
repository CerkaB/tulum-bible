(() => {
  ...
  var inputElement = document.querySelector("#date-picker");
  var maxHours = inputElement.getAttribute("data-max-hours");
  var minHours = inputElement.getAttribute("data-min-hours");
  var disabledDays = inputElement.getAttribute("data-disabled-day");
  new import_air_datepicker.default("#date-picker", {
    locale: import_en.default,
    timepicker: true,
    firstDay: 1,
